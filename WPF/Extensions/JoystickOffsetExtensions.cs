...
namespace TrainDatabase.Extensions
{
    public static class JoystickOffsetExtensions
    {
        ...
        /// <param name="e"></param>
        /// <returns></returns>
        public static int GetMaxValue(this JoystickOffset e) => Convert.ToInt32(Configuration.Get($"{Enum.GetName(e)}_MaxValue")!.IsNullOrWhiteSpace(out string v) ? "0" : v);
        ...
        public static void SetMaxValue(this JoystickOffset e, int value) => Configuration.Set($"{Enum.GetName(e)}_MaxValue", value.ToString());
